                ...
                <div class="project flexColumn width_60">
                    ...
                    <div class="flexColumn width_100 pad15">
                        <form action="" method="post" class="flexColumn width_60 auto">
                            <input id="name" name="name" type="text" placeholder="Nom de la tâche">
                            <input id="project_fk" type="hidden" name="project_fk" value="<?=$_GET['id']?>">
                            <input id="addTodo" type="submit" name="send" value="Ajouter">
                        </form>
                    </div>
                </div>
            </div>
