                                ...
                                if ($state) {
                                    ...
                                    ?>
                                        <div class="width_100 flexRow list">
                                            ...
                                            <a href="editToDo.php?id=<?=$todo['id']?>&id2=<?=$project['id']?>" class="marg10"><i class="far fa-edit"></i></a>
                                            <a href="deleteToDo.php?id=<?=$todo['id']?>&id2=<?=$project['id']?>" class="marg10"><i class="far fa-trash-alt"></i></a>
